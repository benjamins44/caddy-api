...
public class Nutriments {
    ...
    public void setVitaminDValue(String vitaminDValue) {
         this.vitaminDValue = vitaminDValue;
     }
     public String getVitaminDValue() {
         return vitaminDValue;
     }

    public void setNovaGroupServing(String novaGroupServing) {
         this.novaGroupServing = novaGroupServing;
     }
     public String getNovaGroupServing() {
    ...
    public void setCalciumServing(double calciumServing) {
    ...
    public void setNutritionDcoreFr100g(String nutritionDcoreFr100g) {
         this.nutritionDcoreFr100g = nutritionDcoreFr100g;
     }
     public String getNutritionDcoreFr100g() {
         return nutritionDcoreFr100g;
     }

    public void setNovaGroup100g(String novaGroup100g) {
         this.novaGroup100g = novaGroup100g;
     }
     public String getNovaGroup100g() {
    ...
    public void setNutritionDcoreFr(String nutritionDcoreFr) {
         this.nutritionDcoreFr = nutritionDcoreFr;
     }
     public String getNutritionDcoreFr() {
         return nutritionDcoreFr;
     }
    ...
    public void setNutritionDcoreUk100g(String nutritionDcoreUk100g) {
         this.nutritionDcoreUk100g = nutritionDcoreUk100g;
     }
     public String getNutritionDcoreUk100g() {
         return nutritionDcoreUk100g;
     }
    ...
    public void setVitaminDServing(double vitaminDServing) {
    ...
    public void setVitaminDLabel(String vitaminDLabel) {
         this.vitaminDLabel = vitaminDLabel;
     }
     public String getVitaminDLabel() {
         return vitaminDLabel;
     }
    ...
    public void setFiberModifier(String fiberModifier) {
         this.fiberModifier = fiberModifier;
     }
     public String getFiberModifier() {
         return fiberModifier;
     }
    ...
    public void setNutritionDcoreUk(String nutritionDcoreUk) {
         this.nutritionDcoreUk = nutritionDcoreUk;
     }
     public String getNutritionDcoreUk() {
         return nutritionDcoreUk;
     }

    public void setFiberServing(double fiberServing) {
    ...
    public void setVitaminD100g(double vitaminD100g) {
